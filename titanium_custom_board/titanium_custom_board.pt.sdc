...
# PLL Constraints
#################
create_clock -waveform {4.0000 8.0000} -period 8.0000 pll_inst3_CLKOUT0
create_clock -waveform {5.2727 9.2727} -period 8.0000 enet_tx_clock
